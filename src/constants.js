export const techStack = [
  ...
  { name: "Angular", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/angular/angular-original.svg" },
  ...
  { name: "Jira", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jira/jira-original-wordmark.svg" },
  
  { name: "GitHub Pages", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original-wordmark.svg" },
  { name: "Spring Boot", link: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original-wordmark.svg" },
  { name: "Laravel", link: "https://raw.githubusercontent.com/devicons/devicon/master/icons/laravel/laravel-plain.svg" },
  { name: "API", link: "https://img.icons8.com/ios/50/000000/api.png" },
...
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/Maleknoura'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/malekn/'}
]
...
export const serviceData = [
...

  {
    ...
    desc: 'Web application development involves the creation of interactive and dynamic websites that combine web design and functionality. It includes skills such as web graphic design, user interface (UI) design, authoring with standardized code, user experience (UX) design, and search engine optimization (SEO). This ensures robust and scalable web solutions.',
  ...
  
  {
    ...
    desc: `Front-end development involves crafting the user interface and experience of web applications using technologies like HTML, CSS, and JavaScript. It emphasizes responsive design, interactivity, and performance optimization to deliver seamless experiences across devices and browsers.`,
    img: "https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/64/000000/external-web-design-coding-kiranshastry-lineal-color-kiranshastry.png"
  },
  {
    name: 'Backend Development',
    desc: `Backend development focuses on server-side programming to ensure the functionality, scalability, and security of applications. It involves creating APIs, managing databases, and handling server logic to process and serve client requests effectively. This is the backbone of modern applications.`,
